...
# --- STYLE CSS ADAPTATIF (Pour petit écran) ---
st.markdown("""
    <style>
    .responsive-title { font-size: clamp(22px, 5vw, 45px); font-weight: bold; line-height: 1.1; margin-bottom: 5px; }
    .responsive-subtitle { font-size: clamp(16px, 3vw, 22px); color: #555; margin-bottom: 10px; }
    </style>
    """, unsafe_allow_html=True)

# --- LE DICTIONNAIRE MONDIAL (TOUTES LES LANGUES MAJEURES) ---
languages = {
    ...
    "🇻🇳 Việt Nam": {"t": "Máy tính giảm giá của tôi", "st": "Hacker Cosmic 1CA 2026", "p": "Giá gốc", "r": "Giảm giá", "check": "Kiểm tra", "new": "Mới 🔄", "author": "Tạo bởi Règne"}
}
